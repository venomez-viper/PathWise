...
export const CAREER_PROFILES_3: CareerProfile[] = [
  ...
  // 6. Construction Manager
  {
    ...
    groupRoles: ["leader", "doer"], requiredSkills: ["Scheduling (Primavera P6/MS Project)", "Cost Estimating (RSMeans/Bluebeam)", "Contract Administration (AIA Documents)", "OSHA 30 Safety Compliance", "Procore Construction Management"],
  ...
  // 8. PR Specialist
  {
    ...
    groupRoles: ["communicator", "ideator"], requiredSkills: ["Press Release Writing (AP Format)", "Cision/Meltwater Media Databases", "Crisis Communications Planning", "Media Monitoring (Muck Rack)", "Earned Media Measurement (AVE/Barcelona Principles)"],
  ...
  // 9. Real Estate Agent
  {
    ...
    groupRoles: ["communicator", "doer"], requiredSkills: ["MLS Platforms (Bright MLS/Zillow Premier)", "Comparative Market Analysis (CMAs)", "Contract/Addendum Drafting", "Real Estate CRM (Follow Up Boss/KVCore)", "Transaction Coordination (Dotloop/SkySlope)"],
  ...
  // 10. Property Manager
  {
    ...
    managementStyles: ["targets", "mentorship"], careerStages: ["building", "advancing"],
    riskLevels: ["low", "moderate"], trajectories: ["specialist", "manager"],
    groupRoles: ["leader", "doer"], requiredSkills: ["Yardi/AppFolio Property Management Software", "Lease Drafting & Administration", "Fair Housing Law (FHA/HUD)", "CAM Reconciliation", "Building Maintenance Systems (CMMS)"],
  ...
  // 11. Electrician
  {
    ...
    groupRoles: ["doer", "analyst"], requiredSkills: ["NEC Code Compliance", "Blueprint Reading (Bluebeam)", "Conduit Bending (EMT/Rigid)", "Panel/Load Center Installation", "Multimeter/Megger Diagnostics"],
  ...
  // 14. Policy Analyst
  {
    ...
    groupRoles: ["analyst", "advocate"], requiredSkills: ["Statistical Analysis (R/Stata)", "Cost-Benefit Analysis (CBA/BCA)", "Policy Memo Writing (Federal Register Style)", "Survey Design (Qualtrics)", "Legislative Tracking (Congress.gov/FiscalNote)"],
  ...
  // 15. Urban Planner
  {
    ...
    managementStyles: ["mentorship", "targets"], careerStages: ["building", "advancing"],
    riskLevels: ["low"], trajectories: ["specialist", "manager"],
    groupRoles: ["analyst", "leader"], requiredSkills: ["GIS (ArcGIS/QGIS)", "Zoning Ordinance Analysis", "AICP Certification Standards", "Transportation Modeling (VISUM/TransCAD)", "Environmental Review (NEPA/CEQA)"],
  ...
  // 16. Game Designer
  {
    ...
    managementStyles: ["handsoff", "mentorship"], careerStages: ["exploring", "building"],
    riskLevels: ["moderate", "high"], trajectories: ["specialist", "generalist"],
    groupRoles: ["ideator", "doer"], requiredSkills: ["Game Design Documentation (GDD)", "Unity or Unreal Engine", "Rapid Prototyping (Greyboxing)", "Balancing Spreadsheets (Excel/Machinations)", "Level Design Tools (ProBuilder/BSP)"],
  ...
  // 18. Film Director
  {
    ...
    groupRoles: ["leader", "ideator"], requiredSkills: ["Final Draft/WriterSolo Screenwriting", "Cinematography (Camera/Lighting)", "DaVinci Resolve/Avid Editing", "Production Scheduling (StudioBinder)", "Budgeting Software (Movie Magic)"],
  ...
  // 19. Musician (Professional)
  {
    ...
    managementStyles: ["handsoff", "autonomy"], careerStages: ["exploring", "building"],
    riskLevels: ["high"], trajectories: ["specialist", "entrepreneur"],
    groupRoles: ["ideator", "doer"], requiredSkills: ["DAW Production (Ableton/Logic Pro)", "Music Theory (Harmony/Counterpoint)", "MIDI Programming & Sound Design", "Music Licensing (ASCAP/BMI Registration)", "Mixing & Mastering (Pro Tools/iZotope)"],
  ...
  // 21. Conservation Biologist
  {
    ...
    groupRoles: ["analyst", "advocate"], requiredSkills: ["Field Survey Methods (Point Counts/Transects)", "GIS Mapping (ArcGIS/QGIS)", "Species ID Keys (Dichotomous/Molecular)", "Ecological Statistics (R/MARK)", "USFWS Section 7 Consultation"],
    experienceLevels: ["junior", "mid", "senior"], domains: ["Agriculture & Environment"],
    pathwayTime: "4-6 years",
    scoringWeights: { interest: 0.25, personality: 0.20, values: 0.20, aptitude: 0.15, environment: 0.10, stage: 0.10 },
    skillGaps: [
  ...
  // 22. Supply Chain Manager
  {
    ...
    managementStyles: ["targets", "mentorship"], careerStages: ["building", "advancing"],
    riskLevels: ["low", "moderate"], trajectories: ["specialist", "manager"],
    groupRoles: ["leader", "analyst"], requiredSkills: ["ERP Systems (SAP/Oracle SCM)", "Demand Forecasting (Kinaxis/Blue Yonder)", "Procurement Platforms (Coupa/Ariba)", "TMS/WMS Software (Oracle/Manhattan)", "Lean/Six Sigma (Green Belt)"],
  ...
  // 23. Operations Manager
  {
    ...
    groupRoles: ["leader", "analyst"], requiredSkills: ["Lean/Six Sigma (Green Belt)", "ERP Systems (SAP/Oracle)", "KPI Dashboard Design (Tableau/Power BI)", "Workforce Scheduling (Kronos/ADP)", "SOP Documentation & Process Mapping"],
    experienceLevels: ["mid", "senior"], domains: ["Logistics & Operations"],
    pathwayTime: "3-5 years",
    scoringWeights: { interest: 0.25, personality: 0.20, values: 0.20, aptitude: 0.15, environment: 0.10, stage: 0.10 },
    skillGaps: [
  ...
  // 24. Pilot (Commercial)
  {
    ...
    riskLevels: ["low"], trajectories: ["specialist"],
    groupRoles: ["leader", "doer"], requiredSkills: ["IFR/VFR Flight Operations", "Glass Cockpit Avionics (G1000/Garmin)", "CRM (Crew Resource Management)", "ATP Certificate Requirements", "FAA Regulations (FAR/AIM)"],
  ...
  // 25. Air Traffic Controller
  {
    ...
    riskLevels: ["low"], trajectories: ["specialist"],
    groupRoles: ["doer", "analyst"], requiredSkills: ["Radar Separation Standards (7110.65)", "ATC Phraseology (Pilot/Controller Glossary)", "STARS/ERAM Radar Systems", "TRACON/ARTCC Operations", "FAA Order 7110.65 Procedures"],
  ...
  // 26. Hotel Manager
  {
    ...
    managementStyles: ["targets", "mentorship"], careerStages: ["advancing", "building"],
    riskLevels: ["low", "moderate"], trajectories: ["manager", "specialist"],
    groupRoles: ["leader", "doer"], requiredSkills: ["Revenue Management (IDeaS/Duetto)", "Property Management Systems (Opera/Maestro)", "F&B Cost Control (MarketMan)", "Workforce Scheduling (HotSchedules)", "STR Benchmarking Reports"],
  ...
  // 27. Event Planner
  {
    ...
    groupRoles: ["leader", "doer"], requiredSkills: ["Cvent/Eventbrite Platform Management", "Venue Layout Software (AllSeated/Social Tables)", "Event Budgeting (Excel/Planning Pod)", "AV Production Coordination", "RFP/Contract Negotiation"],
  ...
  // 28. Chef (Executive)
  {
    ...
    groupRoles: ["leader", "doer"], requiredSkills: ["Classical French Technique (Escoffier)", "Menu Costing (Food Cost Percentage)", "HACCP/ServSafe Certification", "POS Systems (Toast/Square for Restaurants)", "Inventory Management (MarketMan/BlueCart)"],
  ...
  // 33. Counselor (Licensed Mental Health)
  {
    ...
    managementStyles: ["mentorship", "handsoff"], careerStages: ["building", "advancing"],
    riskLevels: ["low"], trajectories: ["specialist", "entrepreneur"],
    groupRoles: ["advocate", "doer"], requiredSkills: ["CBT/DBT Treatment Protocols", "DSM-5 Diagnostic Assessment", "EHR Documentation (TherapyNotes/SimplePractice)", "HIPAA Compliance", "Evidence-Based Treatment Planning"],
  ...
  // 34. Nonprofit Manager
  {
    ...
    managementStyles: ["mentorship", "targets"], careerStages: ["building", "advancing"],
    riskLevels: ["low", "moderate"], trajectories: ["manager", "specialist"],
    groupRoles: ["leader", "advocate"], requiredSkills: ["Grant Writing (Federal/Foundation)", "Donor CRM (Salesforce NPSP/Bloomerang)", "Fund Accounting (Blackbaud/QuickBooks NP)", "Impact Measurement (Logic Models/SROI)", "990 Tax Filing & Compliance"],
  ...
  // 35. Diplomat / Foreign Service Officer
  {
    ...
    managementStyles: ["mentorship", "targets"], careerStages: ["building", "advancing"],
    riskLevels: ["low", "moderate"], trajectories: ["specialist", "manager"],
    groupRoles: ["leader", "advocate"], requiredSkills: ["Foreign Language Proficiency (FSI Level 3+)", "Cable Writing (State Department)", "Diplomatic Protocol (Vienna Convention)", "Policy Analysis (Country Desk Reports)", "Security Clearance Procedures"],
    experienceLevels: ["junior", "mid", "senior"], domains: ["Law & Policy"],
    pathwayTime: "3-5 years",
    scoringWeights: { interest: 0.25, personality: 0.20, values: 0.20, aptitude: 0.15, environment: 0.10, stage: 0.10 },
    skillGaps: [
  ...
  // 36. Instructional Designer
  {
    ...
    managementStyles: ["handsoff", "mentorship"], careerStages: ["exploring", "building"],
    riskLevels: ["low", "moderate"], trajectories: ["specialist", "generalist"],
    groupRoles: ["doer", "ideator"], requiredSkills: ["ADDIE/SAM Instructional Models", "Articulate Storyline/Rise 360", "LMS Administration (Canvas/Moodle)", "Bloom's Taxonomy Learning Objectives", "SCORM/xAPI Compliance"],
  ...
  // 38. HR Business Partner
  {
    ...
    managementStyles: ["mentorship", "targets"], careerStages: ["building", "advancing"],
    riskLevels: ["low", "moderate"], trajectories: ["specialist", "manager"],
    groupRoles: ["leader", "analyst"], requiredSkills: ["Workday/SuccessFactors HRIS", "HR Analytics (Visier/Tableau)", "Employment Law (FMLA/ADA/Title VII)", "Compensation Benchmarking (PayScale/Mercer)", "Organizational Design Frameworks"],
  ...
  // 40. Physical Therapist
  {
    ...
    managementStyles: ["mentorship", "targets"], careerStages: ["building", "advancing"],
    riskLevels: ["low"], trajectories: ["specialist", "entrepreneur"],
    groupRoles: ["doer", "analyst"], requiredSkills: ["Musculoskeletal Assessment (Special Tests)", "Manual Therapy Techniques (Maitland/Mulligan)", "Therapeutic Exercise Prescription (HEP)", "Gait Analysis Software (Dartfish/TEMPLO)", "EMR Documentation (WebPT/Net Health)"],
...

  {
    ...
    interests: ["artistic", "social"], problemTypes: ["creative", "strategic"], archetypes: ["creator", "communicator"],
    workStyles: ["open", "experiment"], decisionStyle: ["intuition", "feeling"], collaboration: ["solo"],
    ambiguityStyle: ["experiment"], coreValues: ["autonomy", "purpose"], tradeoffs: ["growth_over_comfort"],
    frustrations: ["monotony", "micromanaged"], rewards: ["recognition", "impact"],
    environments: ["remote", "flexible"], teamSizes: ["solo", "small"], paces: ["burst"],
    managementStyles: ["handsoff"], careerStages: ["exploring", "building"],
    riskLevels: ["high", "moderate"], trajectories: ["entrepreneur"],
...

  {
    ...
    interests: ["artistic", "social"], problemTypes: ["creative", "communication"], archetypes: ["communicator", "connector"],
    workStyles: ["open", "collaborative"], decisionStyle: ["intuition"], collaboration: ["collaborative"],
    ambiguityStyle: ["experiment"], coreValues: ["creativity", "connection"], tradeoffs: ["balance_over_creativity"],
    frustrations: ["algorithm_changes", "content_burnout"], rewards: ["recognition", "creativity"],
    environments: ["remote", "hybrid"], teamSizes: ["small"], paces: ["fast"],
    managementStyles: ["handsoff"], careerStages: ["exploring", "building"],
    riskLevels: ["low"], trajectories: ["specialist"],
    groupRoles: ["ideator", "presenter"], requiredSkills: ["Meta Business Suite/Creator Studio", "Sprout Social/Hootsuite", "Canva/Adobe Express", "Social Listening Tools (Brandwatch)", "Platform Analytics (Instagram Insights/TikTok Analytics)"],
