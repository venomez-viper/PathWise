...
export const CAREER_PROFILES_3: CareerProfile[] = [
...

  {
    ...
    workStyles: ["open", "collaborative"], decisionStyle: ["intuition", "feeling"], collaboration: ["collaborative"],
    ...
    riskLevels: ["low", "moderate"], trajectories: ["specialist"],
    groupRoles: ["ideator", "presenter"], requiredSkills: ["Content Strategy", "Copywriting", "Analytics", "Graphic Design", "Community Management"],
