  ...
  return (
    <div className="panel" style={{ borderRadius: '1.5rem', padding: '1.1rem 1.2rem' }}>
      <h4 style={widgetTitleStyle}>
        <Target size={15} color="var(--secondary)" /> Milestone Map
      </h4>
      <div style={{ marginTop: 10, display: 'flex', flexDirection: 'column', gap: 4 }}>
        {filterMilestoneId && (
          <button
            ...
            style={{
              fontSize: '0.7rem', color: 'var(--copper)', background: 'rgba(139,79,44,0.08)',
          ...
          return (
            <button
              ...
              style={{
                ...
                border: isFiltered ? '1.5px solid var(--copper)' : '1px solid transparent',
            ...
            >
              ...
              <span style={{
                ...
                color: isActive ? 'var(--copper)' : isCompleted ? '#059669' : 'var(--on-surface-variant)',
