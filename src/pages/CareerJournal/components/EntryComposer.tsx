...
export function EntryComposer({
  ...
  return (
    <div
      className={`rounded-2xl bg-white/70 backdrop-blur-md ring-1 ring-teal-100 shadow-sm p-6 transition-all duration-300
    ...
    >
      <textarea
        ...
        rows={5}
        className="w-full resize-none bg-transparent text-lg leading-relaxed text-slate-900 placeholder:text-slate-400 focus:outline-none"
      />
      <div className="mt-5 flex items-center justify-between">
        ...
        <button
          ...
          className="cursor-pointer rounded-lg bg-[#6245a4] px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#4a3280] disabled:cursor-not-allowed disabled:opacity-50"
        >
          {saving ? "Saving…" : "Save"}
        </button>
      </div>
