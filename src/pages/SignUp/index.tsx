    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Email */}
          <div className="space-y-2">
            <Label htmlFor="signup-email" style={{ color: 'var(--on-surface)' }}>Email address</Label>
            <Input
              id="signup-email"
              type="email"
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full h-11 rounded-xl bg-white/80 border-black/8 gap-2 font-medium opacity-50 cursor-not-allowed"
